#include "defensetower_3.h"

DefenseTower_3::DefenseTower_3(const int x, const int y) : TowerBaseClass(x, y)
{
    width = 110, height = 80;   //防御塔宽高
    picturePath = "../PictureMaterial/cannon_3.png";    //防御塔图片路径
    range = 260;
    attackPower = 70;
    value = 400;
...
void DefenseTower_3::Attack(QVector<EnemyBaseClass*>& enemyVec)
{
