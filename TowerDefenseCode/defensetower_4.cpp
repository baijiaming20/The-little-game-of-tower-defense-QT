#include "defensetower_4.h"

DefenseTower_4::DefenseTower_4(const int x, const int y) : TowerBaseClass(x, y)
{
    width = 110, height = 80;   //防御塔宽高
    picturePath = "../PictureMaterial/cannon_4.png";    //防御塔图片路径
    range = 300;
    attackPower = 80;
    value = 700;
...
void DefenseTower_4::Attack(QVector<EnemyBaseClass*>& enemyVec)
{
    ...
    for(auto bull : BulletVec)
        ...
        {
        case 0: bull->y -= 8, bull->x -= 8; break;
        case 1: bull->y += 8, bull->x += 8; break;
        case 2: bull->x -= 8, bull->y += 8; break;
        case 3: bull->x += 8, bull->y -= 8; break;
        case 4: bull->y -= 8; break;
        case 5: bull->y += 8; break;
        case 6: bull->x -= 8; break;
        case 7: bull->x += 8; break;
        }
